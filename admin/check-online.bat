...
powershell -NoProfile -Command "try { $r=Invoke-WebRequest -Uri '!HEALTH_URL!' -UseBasicParsing -TimeoutSec 90; Write-Host 'OK:' $r.Content } catch { Write-Host 'OSHIBKA:' $_.Exception.Message; exit 1 }"
if errorlevel 1 (
