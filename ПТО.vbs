' Тихий запуск «Golden Section»: без чёрного окна cmd (вызывает pythonw / pyw).
Option Explicit
...
' Сначала «pyw -3» из Windows (типичная установка python.org)
